    ...
    fn stop_internal(&mut self) {
        ...
        let _ = self.monitor.active_deadlines[*self.state_index]
            ...
            .update(|mut current| {
                ...
                return Some(DeadlineStateSnapshot::default()); // Reset to stopped state as all fine
            });
...
mod tests {
    ...
    fn create_monitor_with_deadlines() -> DeadlineMonitor {
        ...
        DeadlineMonitorBuilder::new()
            .add_deadline(
                ...
                TimeRange::new(std::time::Duration::from_secs(1), std::time::Duration::from_secs(50)),
            )
            .add_deadline(
    ...
    fn create_monitor_with_multiple_running_deadlines() -> DeadlineMonitor {
        ...
        DeadlineMonitorBuilder::new()
            .add_deadline(
                &IdentTag::from("slow"),
                TimeRange::new(std::time::Duration::from_secs(0), std::time::Duration::from_secs(50)),
            )
            .add_deadline(
    ...
    fn start_stop_deadline_within_range_works() {
        ...
        std::thread::sleep(std::time::Duration::from_millis(1001)); // Sleep to simulate work within the deadline range
    ...
    fn monitor_with_multiple_running_deadlines() {
        ...
        std::thread::sleep(std::time::Duration::from_millis(51)); // Sleep to simulate work within the deadline range
